...
/**
 * 测试 WebSocket send 功能 - 使用 call 帧格式
 */
...
console.log('====================================')
console.log('  测试 WebSocket send 功能')
console.log('====================================')
console.log('')
...
ws.on('message', (data) => {
  ...
  if (msg.type === 'res' && msg.ok && msg.payload?.type === 'hello-ok') {
    ...
    // 认证成功后，发送 req/res 帧调用 send 方法
    console.log('正在发送 req/res 帧调用 send 方法...')
...
如果收到此消息，说明 WebSocket 配置正常！`
    ...
    console.log('发送 req 帧:', JSON.stringify(sendReq, null, 2))
