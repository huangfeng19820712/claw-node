...
console.log('====================================')
console.log('  使用已保存的凭证连接 Gateway')
console.log('====================================')
console.log('')
...
ws.on('message', async (data) => {
  ...
  if (msg.type === 'event' && msg.event === 'connect.challenge') {
    ...
    console.log(`✓ 收到 challenge: ${nonce}`)
  ...
  if (msg.type === 'res') {
    if (msg.ok && msg.payload?.type === 'hello-ok') {
      ...
      console.log('')
      console.log('服务器信息:')
      console.log(`  版本：${msg.payload.server?.version}`)
      console.log(`  协议：${msg.payload.protocol}`)
      console.log('')
