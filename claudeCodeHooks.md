...
<Frame>
  <img src="claudeCodeHooks.assets/hook-resolution.svg+xml" alt="Hook 解析流程：PreToolUse 事件触发，匹配器检查 Bash 匹配，hook 处理程序运行，结果返回到 Claude Code" width="780" height="290" data-path="images/hook-resolution.svg" />
</Frame>
